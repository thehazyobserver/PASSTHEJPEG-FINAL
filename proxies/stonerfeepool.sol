    ...
    IERC721ReceiverUpgradeable
{
    ...
    /**
     * @dev Add ERC20 rewards to the pool for a whitelisted token
    ...
    /**
     * @dev Claim rewards for a specific ERC20 token
     * @param token The ERC20 token to claim rewards for
     */
    ...
    /**
     * @dev Claim all available ERC20 rewards for the caller
     */
    ...
    /**
     * @dev Convenience: claim both native ETH and all ERC20 rewards
     */
     ...
     * @param token The ERC20 token address to remove from whitelist
     */
    ...
    /**
     * @dev Emergency withdrawal of ERC20 tokens by admin
    ...
    /**
     * @dev Emergency withdrawal of native ETH by admin
    ...
    /**
     * @dev Calculate pending ERC20 rewards for a specific token and user
    ...
    /**
     * @dev Get pending rewards for all whitelisted tokens for a user
     * @param user The user address
     * @return tokens Array of token addresses
     * @return rewardAmounts Array of pending reward amounts (same order as tokens)
     */
    ...
    /**
     * @dev Get ERC20 pool info for a specific token
     * @param token The ERC20 token address
     * @return tokenAddress The token address
     * @return totalClaimedAmount Total rewards claimed for this token
     * @return contractBalance Current token balance in the contract
    ...
    /**
     * @dev Get earned ERC20 rewards for a specific token
     * @param user The user address
     * @param token The ERC20 token address
